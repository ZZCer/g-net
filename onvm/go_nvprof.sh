...
sudo /usr/local/cuda-9.2/bin/nvprof -f -o mgr_prof --device-buffer-size 1024 $SCRIPTPATH/onvm_mgr/$RTE_TARGET/onvm_mgr -l $cpu -n 5 --proc-type=primary --log-level 7 -- -p${ports}
